...
x3= int(brasil_recovered[len(brasil_recovered)-1])
x4= casos
...
matplotlib.pyplot.plot(graphT,graphX3,label='R(t)')
matplotlib.pyplot.xlabel('tempo (t)')
matplotlib.pyplot.ylabel('valores (C(t) M(t) e R(t))')
